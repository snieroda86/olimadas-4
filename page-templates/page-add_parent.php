	...
	<main id="primary" class="site-main">
        ...
        <?php if(is_user_logged_in()): ?>
					...
					<div class="text-center pt-2 pb-4">
						<?php $child_name = get_post($_GET['child_id']); ?>
						<?php if ( !empty($child_name)): ?>
							<h4><span>Create <?php echo( $_GET['sex']=='male') ? 'sire'  : 'dam' ;      ?> for </span><span><?php echo $child_name->post_title; ?></span></h4>	
						<?php endif ?>
	            ...
	            <?php } ?>
					...
					<div class="tabs-wrapper-sn m-auto">
						...
						<div class="tab-content" id="pills-tabContent">
						  ...
						  <!-- Create new parent -->
						  <div class="tab-pane fade" id="new-parent" role="tabpanel" aria-labelledby="new-parent-tab">
